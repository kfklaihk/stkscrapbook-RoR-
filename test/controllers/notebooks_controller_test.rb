...
class NotebooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notebook" do
    assert_difference('Notebook.count') do
      post notebooks_url, params: { notebook: { category: @notebook.category, datme: @notebook.datme, fileurl: @notebook.fileurl, fmt: @notebook.fmt, stkcode: @notebook.stkcode, userid: @notebook.userid } }
    end
  ...
  test "should update notebook" do
    patch notebook_url(@notebook), params: { notebook: { category: @notebook.category, datme: @notebook.datme, fileurl: @notebook.fileurl, fmt: @notebook.fmt, stkcode: @notebook.stkcode, userid: @notebook.userid } }
